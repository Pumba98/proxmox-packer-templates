...
name           = "alpine-3.19-template"
iso_file       = "alpine-virt-3.19.2-x86_64.iso"
iso_url        = "https://dl-cdn.alpinelinux.org/alpine/v3.19/releases/x86_64/alpine-virt-3.19.2-x86_64.iso"
iso_checksum   = "file:https://dl-cdn.alpinelinux.org/alpine/v3.19/releases/x86_64/alpine-virt-3.19.2-x86_64.iso.sha256"
