...
iso_file       = "alpine-virt-3.20.7-x86_64.iso"
iso_url        = "https://dl-cdn.alpinelinux.org/alpine/v3.20/releases/x86_64/alpine-virt-3.20.7-x86_64.iso"
iso_checksum   = "file:https://dl-cdn.alpinelinux.org/alpine/v3.20/releases/x86_64/alpine-virt-3.20.7-x86_64.iso.sha256"
http_content = {
  "/answers" = {
...
boot_command_local_file = [
  "root<enter><wait>",
  "mkdir -p /media/setup<enter><wait>",
  "mount /dev/sr0 /media/setup<enter><wait>",
  "setup-alpine -f /media/setup/answers<enter><wait5>",
  "packer<enter><wait>",
  "packer<enter><wait5>",
  "<enter><wait5>",
  "y<enter><wait5>",
  ...
  "umount /mnt/dev<enter><wait1>",
  "umount /mnt<enter><wait1>",
  "umount /media/setup<enter><wait1>",
  "reboot<enter>"
]
provisioner = [
