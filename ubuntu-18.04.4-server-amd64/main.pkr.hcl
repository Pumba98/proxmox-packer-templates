...
variable "iso_file" {
  type    = string
  default = "ubuntu-18.04.4-server-amd64.iso"
}
...
variable "iso_url" {
  type    = string
  default = "https://old-releases.ubuntu.com/releases/18.04.4/ubuntu-18.04.4-server-amd64.iso"
}
...
locals {
  template_description = "Ubuntu 18.04, generated by packer on ${formatdate("YYYY-MM-DD hh:mm:ss", timestamp())}"
}
