...
variable "iso_file" {
  type    = string
  default = "debian-10.10.0-amd64-netinst.iso"
}
...
variable "iso_url" {
  type    = string
  default = "https://cdimage.debian.org/mirror/cdimage/archive/10.10.0/amd64/iso-cd/debian-10.10.0-amd64-netinst.iso"
}
...
variable "template_name" {
  type    = string
  default = "debian-10-10-0-template"
}
...
locals {
  template_description = "Debian 10.10.0, generated by packer on ${formatdate("YYYY-MM-DD hh:mm:ss", timestamp())}"
}
