...
variable "iso_url" {
  type    = string
  default = "https://cdimage.debian.org/debian-cd/current/amd64/iso-cd/debian-11.0.0-amd64-netinst.iso"
}
...
locals {
  template_description = "Debian 11, generated by packer on ${formatdate("YYYY-MM-DD hh:mm:ss", timestamp())}"
}
